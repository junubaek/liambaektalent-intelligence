...
if row:
    ...
    # Generate Embedding for Neo4j (using full text or summary as per embed_candidates.py logic)
    ...
    session.run("""
        ...
        SET n.summary = $summary,
            ...
            n.sector = $sector,
            n.embedding = $emb
    """, cid=str(cid), summary=summary or "", company=current_company or "", sector=sector or "미분류", emb=main_emb)
    session.close()
    print("Neo4j updated (including embedding).")
