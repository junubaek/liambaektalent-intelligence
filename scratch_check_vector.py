...
res = openai_client.embeddings.create(model='text-embedding-3-small', input=['SoC NoC Network_on_Chip Chiplet semiconductor architect'])
...
with driver.session() as session:
    ...
    target_id = '1aaad2d3-348d-48f7-8501-38d7c1f7df03'
