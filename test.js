            ...
            container.innerHTML = `
                ...
                <div class="grid gap-5 pb-20">
                    ${matched.map((c, i) => {
                        ...
                        const summary = c["Experience Summary"] || '정보 없음';
                                ...
                                <div id="detail-${id}" class="${isExpandedHTML} border-t border-slate-50 bg-[#FBFCFD] p-12 animate-fade-in cursor-default" onclick="event.stopPropagation()">
                                    <div class="space-y-12">
                                        <div class="space-y-4 pb-10 border-b border-slate-100">
                                            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 text-[11px] font-black uppercase tracking-tighter">
                                            ...
                                            <div class="flex items-center gap-10 text-[11px] font-bold text-slate-400 uppercase tracking-[0.1em] pt-2">
                                        ...
                                        <div class="pt-10 border-t border-slate-100 flex justify-end">
                                            <a href="${notion_url}" target="_blank" class="flex items-center gap-3 px-10 py-4.5 bg-black text-white rounded-full text-[11px] font-black uppercase tracking-widest hover:scale-105 transition-all shadow-xl shadow-black/10">
