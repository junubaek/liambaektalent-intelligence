...
jd_path = "jd_compiler.py"

with open(jd_path, "r", encoding="utf-8") as f:
    text = f.read()

idx1 = text.find('    # [Phase 3: Weighted Sum Fusion (Two-Tower)]')
idx2 = text.find('def normalize_query_with_map', idx1)

if idx1 == -1 or idx2 == -1:
    print("Error finding boundaries")
    exit(1)

new_phase3 = """    # [Phase 3: Weighted Sum Fusion (Two-Tower)]
...
new_text = text[:idx1] + new_phase3 + text[idx2:]
