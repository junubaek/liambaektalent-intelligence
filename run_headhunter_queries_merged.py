...
QUERIES = []
for q in round1_queries + round2_queries:
    if q not in QUERIES:
        QUERIES.append(q)

def main():
    print(f"Headhunter QA Testing v8.5 with {len(QUERIES)} Merged Queries...")
    results = {}
    zero_hits = []
    ...
    with open("headhunter_qa_merged_report.md", "w", encoding="utf-8") as f:
        f.write("# Headhunter Merged QA Report\n\n")
        f.write("## Zero Hits\n")
    ...
    print("\n✅ Testing completed! Saved to headhunter_qa_merged_report.md")
