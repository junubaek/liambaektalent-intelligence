...
print("━━━━━━━━━━━━━━━━━━━━\n1. Pinecone 샘플 3개 확인 (resume_vectors)\n━━━━━━━━━━━━━━━━━━━━")
try:
    ...
    if res and "matches" in res:
        ...
        print("No matches found in resume_vectors.")
except Exception as e:
    import traceback
    traceback.print_exc()

print("━━━━━━━━━━━━━━━━━━━━\n3. 예상 벡터 수 (청크) 계산 (1000자 기준)\n━━━━━━━━━━━━━━━━━━━━")
try:
    db_path = os.path.join(ROOT_DIR, "candidates.db")
    conn = sqlite3.connect(db_path)
    cur = conn.cursor()
    cur.execute("SELECT length(raw_text) FROM candidates WHERE is_duplicate=0 AND is_parsed=1 AND raw_text IS NOT NULL")
    rows = cur.fetchall()
    ...
    for row in rows:
        ...
        chunks = max(1, length // chunk_size + (1 if length % chunk_size > 0 else 0))
        total_chunks += chunks
