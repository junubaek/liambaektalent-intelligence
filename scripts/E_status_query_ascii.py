...
def run_status_query():
    ...
    print("━━━━━━━━━━━━━━━━━━━━")
    print("\n[ 1. 파싱 미완료 규모 ]")
    print(f"- 1-1. is_parsed=0: {q1_1}")
    print(f"- 1-2. Summary Empty: {q1_2_summary_empty}")
    print(f"- 1-3. Company Empty: {q1_3_company_empty}")
    
    print("\n[ 2. raw_text 노출(개인정보) 규모 ]")
    print(f"- 2. Privacy Info in Summary: {q2_privacy_exposure}")
    
    print("\n[ 3. raw_text 자체 없는 케이스 ]")
    print(f"- 3. raw_text Empty: {q3_raw_empty}")
