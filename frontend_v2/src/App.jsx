    ...
    <div className="flex h-screen bg-[#f7f8fa] text-gray-900 font-sans overflow-hidden">
      ...
      <aside className="w-[17rem] bg-white border-r border-gray-200 flex flex-col justify-between flex-shrink-0 z-10">
        <div className="flex-1 flex flex-col overflow-hidden">
          <div onClick={goHome} className="h-24 flex items-center px-6 border-b border-gray-100 cursor-pointer hover:bg-gray-50 transition-colors flex-shrink-0 group justify-center">
            <img src={logoImg} alt="Markdown Logo" className="h-20 w-auto object-contain mix-blend-multiply transition-transform group-hover:scale-[1.02]" />
          </div>
            ...
            <div className="max-w-5xl mx-auto flex flex-col h-full min-h-[60vh] py-10 animate-fade-in-up">
              <div className="mb-14 mt-6">
                <div className="flex items-center justify-start gap-6 mb-5 select-none">
                  <img src={logoImg} alt="Markdown Logo" className="h-44 w-auto object-contain mix-blend-multiply transition-transform hover:scale-[1.02]" />
                </div>
